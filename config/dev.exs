...
config :trees, TreesWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "U2SesplL2VhZNJcPO9qAv9letlJpeX+0FGi16HxRouH7v7dWzTWQ0xljQPusI/Nn",
  watchers: [
...
config :trees, TreesWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/trees_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :trees, dev_routes: true
